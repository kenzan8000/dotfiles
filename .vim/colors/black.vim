...
hi Visual       guifg=gray      guibg=darkblue  gui=none    ctermfg=bg           ctermbg=blue      cterm=none
hi VisualNOS    guifg=gray      guibg=darkblue  gui=none    ctermfg=bg           ctermbg=blue      cterm=none

hi Todo         guifg=bg        guibg=#aaaa00    gui=none    ctermfg=bg          ctermbg=yellow    cterm=none
hi Search       guifg=gray      guibg=darkgreen  gui=none    ctermfg=bg          ctermbg=darkcyan  cterm=none
